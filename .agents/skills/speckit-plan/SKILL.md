...
| PowerShell | `pwsh -NoProfile -File .specify/scripts/powershell/setup-plan.ps1 -Json` |
...
1. **Setup**: Run the command selected under **Comando de esta skill** from repo root and parse JSON for FEATURE_SPEC, IMPL_PLAN, SPECS_DIR, BRANCH.
